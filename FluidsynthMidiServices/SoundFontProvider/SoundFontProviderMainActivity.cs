...
using FluidsynthMidiServices;

namespace FluidsynthMidiServices.SoundFontProvider
{
	[Activity (Label = "SoundFont Provider", Icon = "@mipmap/icon", Theme="@style/Theme.Styled")]
	public class SoundFontProviderMainActivity : AppCompatActivity
	{
		...
		protected override void OnCreate (Bundle savedInstanceState)
		{
			...
			SetContentView (Resource.Layout.SoundFontProviderMain);
